...
const modals = [
    {
        ...
        content: [
            ...
            "というコンセプトを掲げたアプリです。",
            <br />,
            "ジャーナリングを続けるために、「ジャーナルから気分を解析し、その気分に適した音楽を推薦する。」",
    ...
    },
    {
        ...
        title: "ジャーナリングとは?",
        content: [
            "一言で表すと、自分自身の気持ちを言語化することです。",
            "自らの内面を知り、明確な言葉とする。メンタルヘルスやマインドフルネスの方法として注目されている方法です。",
            <br />,
            "やり方は単純明快で、紙などに今現在の自分の正直な気持ちを書き綴ります。",
            "日記などとは違い正確さなどは求めず、表現の統一などは気にせずに心のままに文字で埋め尽くしていきます。",
            <br />,
    ...
    },
    {
        ...
        content: [
            ...
            "このまま本文を入力してもよいですが、画面右下にあるメニューから好きな背景画像を選択することもできます。",
            "また右上のメニューのアイコンをクリックで、サイト全体のカラーテーマを選択できます。",
            <br />,
            "一番書きやすい環境を選択し、気持ちのままにジャーナリングを行ってください。",
            "タイトルは入力せずとも、保存や解析に進むことができます。",
        ],
    ...
    },
    {
        ...
        content: [
            ...
            "更に作成したジャーナルについてAIからのフィードバックが生成されます。",
            "レコメンドリンクをクリックでレコメンド画面へ遷移します。",
        ],
    ...
    },
    {
        ...
        title: "音楽のレコメンド",
        content: [
            "先ほど生成したレコメンド内容に適した音楽が表示されます。",
            "一度に最大で100曲の音楽が表示されます。クリックで視聴することができます。",
            <br />,
            "下の更新ボタンをクリックで、同じレコメンド内容の音楽を検索し直します。",
        ],
    ...
    },
    {
        ...
        title: "履歴",
        content: [
            "右上のメニューを開き、「Journaling」をクリックでジャーナリング画面に戻ります。",
            <br />,
            "ジャーナリング画面右下の「Journaling History」から過去に保存したジャーナルを閲覧することができます。",
            "自動で作成した日時が保存されるので、その日時とジャーナルの内容を見て自身の変化を実感することができます。",
        ],
    ...
    },
    {
        ...
        content: [
            ...
            <br />,
            "「なりたい気分」と「音楽のジャンル」、この二つを選択し、下に表示された文字をクリックでレコメンド画面へ遷移します。",
            "ジャーナリングの解析で得られるレコメンド機能を、クリックだけで簡単に得ることができます。",
            <br />,
            "今の気分を変える音楽を探したいときに使用してみてください。",
        ],
