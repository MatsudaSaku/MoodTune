...
- 1.用意された背景を選択するか、カラーテーマ、画像のアップロードなどで好きな背景を設定し、ジャーナリングを行います。
...
- 3.先ほど書いたジャーナルを解析し、現在の気分を「興奮」「不安」「悲しみ」「楽しみ」の四つに数値化してくれます。
...
- 4.今回は「前向きな気分になれる、rock、soul、rainy-day」のレコメンド画面が表示されます。
