...
**Spotify APIに審査が必要となったため開発終了としました。**
 
## 概要
**「音楽推薦やAIからのフィードバックという小さな目的を重ねていくことで、ジャーナリングを楽しみながら継続していく」**

そしてジャーナリングの効果である、**自己理解と目標達成を実現していく**としたプロダクトです。
...
- 4.今回生成された「前向きな気分になれる、rock、soul、rainy-day」のレコメンド画面が表示されます。
 一度に最大100曲まで表示されますが、下部にある更新ボタンをクリックで同じオススメジャンルを新しく検索、表示します。
...
<img src="https://github.com/user-attachments/assets/0569c752-5595-4923-9fff-b57c63301172" width="80%">
